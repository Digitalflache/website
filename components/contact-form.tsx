...
export function ContactForm() {
  ...
  return (
    <form
      ...
      className="space-y-4"
      aria-describedby={
        serverMessage ? "form-status-message" : undefined
      }
    >
        ...
        <div>
          ...
          >
            ...
            <option value="landingpage">
              Landingpage oder One Pager
            </option>
            <option value="webapp">Web App / Tool / MVP</option>
            <option value="relaunch">
              Relaunch oder Optimierung bestehender Website
            </option>
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <p className="text-xs text-slate-400 sm:text-sm">
          In der Regel erhältst du innerhalb von 24–48 Stunden eine
          Antwort. Falls es besonders dringend ist, erwähne das
          bitte in der Nachricht.
        </p>
      </div>
